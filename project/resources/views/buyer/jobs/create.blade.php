                ...
                <form id="request-form" action="{{ route('buyer.job.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row gy-4">
                        ...
                        <div class="col-sm-4 offline-class">
                            ...
                            <select name="job_area_id" id="area" class="form-control d-none">
                        ...
                        <div class="col-sm-12">
                            ...
                            <textarea name="description" id="description" class="form-control" placeholder="@lang('Service Description')"></textarea>
                        </div>
