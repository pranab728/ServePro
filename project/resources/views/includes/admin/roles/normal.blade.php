...
@if(Auth::guard('admin')->user()->sectionCheck('All Jobs'))
<li class="nav-item">
...
<li class="nav-item">
  ...
  <div id="all-order" class="collapse" aria-labelledby="headingTable" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
          <a class="collapse-item" href="{{ route('admin.services.index') }}">{{ __('All Orders') }}</a>
          <a class="collapse-item" href="{{ route('admin.services.pending') }}">{{ __('Cancelled Order') }}</a>
