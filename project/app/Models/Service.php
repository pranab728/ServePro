...
class Service extends Model
{
    ...
    ,'description','image','image_gallery','video','image','video','status','is_service_on','price','online_service_price','delivery_days','revision','is_service_online','tax','view','sold_count','featured','created_at','updated_at','is_best','is_popular','is_trending','is_featured','is_new'];
