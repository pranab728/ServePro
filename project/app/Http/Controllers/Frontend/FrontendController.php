...
class FrontendController extends Controller
{
    ...
    public function index(){
        ...
        $data['best_services']= Service::where('status',1)->where('is_best',1)->orderBy('id','desc')->limit(6)->get();
        $data['popular_services']= Service::where('status',1)->where('is_popular',1)->orderBy('id','desc')->limit(6)->get();
        $data['featured_services']= Service::where('status',1)->where('is_featured',1)->orderBy('id','desc')->limit(6)->get();
    ...
    public function allservices(Request $request){
        ...
        $data['services']= Service::when($country, function ($query) use ($country) {
    ...
    public function servicesearch(request $request){
            ...
            $data['search']= $request->search;
            $data['areas'] = Area::where('status',1)->get();
            $data['services'] = Service::where('title', 'like', '%' . $data['search'] . '%')->orWhere('description', 'like', '%' . $data['search'] . '%')->paginate(9);
            return view('frontend.services',$data);
    }
